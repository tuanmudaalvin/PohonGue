...
<div class="wrapper">
                ...
                <div class="col-md-12">
                    ...
                    <form action="create.php" method="post" name="form1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumlah_pohon" class="form-control">
                        </div>
                        </div>
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($conn, "INSERT INTO petani(nama, email, jumlah_pohon) VALUES('$nama','$email','$jumlah_pohon')");
