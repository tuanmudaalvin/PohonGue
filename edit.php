...
{	
    ...
    $nama = $_POST['nama'];
    $email = $_POST['jenis'];
    $jumlah_pohon = $_POST['harga'];
        
    // update user data
    $result = mysqli_query($conn, "UPDATE petani SET nama='$nama', email='$email', jumlah_pohon='$jumlah_pohon' WHERE id=$id");
...
$result = mysqli_query($conn, "SELECT * FROM petani WHERE id='" . $_GET['id'] . "'");
                ...
                <div class="col-md-12">
                    ...
                    <form name="update" method="post" action="edit.php">
                        <div class="form-group">
                            <label><b>Nama Petani</b></label>
                            <input type="text" name="nama" class="form-control" value="<?php echo $row['nama']; ?>">
                        </div>
                        <div class="form-group">
                            <label><b>Email</b></label>
                            <textarea name="jenis" class="form-control"><?php echo $row['email']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label><b>Jumlah Pohon</b></label>
                            <input type="text" name="harga" class="form-control" value="<?php echo $row['jumlah_pohon']; ?>">
                        </div>
                        <tr>
